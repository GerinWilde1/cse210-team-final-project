...
class Point:
    def __init__(self):
        self.x= 1
        self.y= random.uniform(SCREEN_HEIGHT, 1)
...
class Paddle:
    ...
    def draw(self):
        ...
        arcade.draw_rectangle_filled(self.center.x + SCREEN_WIDTH - PADDLE_WIDTH, self.center.y, PADDLE_WIDTH, PADDLE_HEIGHT, arcade.color.BLUE)
